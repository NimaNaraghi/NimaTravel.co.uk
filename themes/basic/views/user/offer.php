...
<br>
Departure: <span class="glyphicon glyphicon-calendar" aria-hidden="true"></span> <?= $offer->departure_date ? Yii::$app->formatter->asDate($offer->departure_date) : Yii::$app->formatter->asDate($offer->preference->departure_date) ?> <br>
Return: <span class="glyphicon glyphicon-calendar" aria-hidden="true"></span> <?= $offer->return_date ? Yii::$app->formatter->asDate($offer->return_date) : Yii::$app->formatter->asDate($offer->preference->return_date) ?> <br>
...
<div class="col-md-4">
    <p class="text-danger"> Please take the survey before leaving :) </p>
